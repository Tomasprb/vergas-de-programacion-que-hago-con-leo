...
public class BuscarCat extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buscar_cat);
        ...
        BuscarCat.tareaAsincronica miTarea = new BuscarCat.tareaAsincronica();
        miTarea.execute();
    }
    ...
    AdapterView.OnItemClickListener Escuchador = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int posicionSeleccionada, long id) {
            ...
            irAMostrarObjetos = new Intent(BuscarCat.this, MostrarObjetos.class);
            String categoriaSeleccionada = miListaCategorias.getItemAtPosition(posicionSeleccionada).toString();
